						...
						<form action="<?php base_url('admin/peserta/add') ?>" method="post" enctype="multipart/form-data" >
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nis') ? 'is-invalid':'' ?>"
								 type="text" name="nis" placeholder="NIS" value="<?php echo $peserta->nis ?>" readonly />
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nis') ? 'is-invalid':'' ?>"
								 type="text" name="nis_lengkap" placeholder="NIS" value="<?php echo $peserta->nis_lengkap ?>" readonly/>
								<div class="invalid-feedback">
									<?php echo form_error('nis') ?>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('nama') ? 'is-invalid':'' ?>"
								 type="text" name="nama"  placeholder="nama lengkap" value="<?php echo $peserta->nm_lengkap?>" />
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('namaOrtu') ? 'is-invalid':'' ?>"
								 type="text" name="namaOrtu"  placeholder="namaOrtu" value="<?php echo $peserta->nm_ortu?>"/>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<textarea class="form-control <?php echo form_error('alamat') ? 'is-invalid':'' ?>"
								 name="alamat" placeholder="alamat"><?php echo $peserta->alamat?></textarea>
								<div class="invalid-feedback">
							...
							<div class="form-group">
								...
								<input class="form-control <?php echo form_error('pekerjaan') ? 'is-invalid':'' ?>"
								 type="text" name="pekerjaan"  placeholder="pekerjaan"  value="<?php echo $peserta->pekerjaan?>"/>
								<div class="invalid-feedback">
